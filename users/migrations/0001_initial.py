    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('CITIZEN', 'Citizen'), ('NGO', 'NGO'), ('VOLUNTEER', 'Volunteer')], default='CITIZEN', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ngo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='volunteers', to='users.ngoprofile')),
